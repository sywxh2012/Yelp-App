...
**My Yelp** is a Yelp search app using the [Yelp API](http://www.yelp.com/developers/documentation/v2/search_api).
...
<img src='https://github.com/sywxh2012/Yelp-App/blob/master/Yelp_videoWalkThrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
